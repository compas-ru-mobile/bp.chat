...
class ChatItem(ListModelItem, ColoredItem):
    ...
    def isSelectedItem(self):
        if hasattr(self.model, 'check_item_is_selected'):
            return self.model.check_item_is_selected(self)
...
class MessageItem(ListModelItem):
    ...
    def getSecondText(self):
        return self.fix_text_a(self.message.text)
